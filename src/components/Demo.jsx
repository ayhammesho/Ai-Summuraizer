...
const Demo = () => {
  ...
  useEffect(() => {
    ...
    if (artilcesFromLocalStorage) {
      setAllArticles(artilcesFromLocalStorage);
    }
  }, []);
    ...
    <section className="mt-16 w-full max-w-xl">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        >
          ...
          <button
            type="submit"
            className="submit_btn peer-focus:border-sky-700 peer-focus:text-sky-700"
          >
            <svg
      ...
      <div className="my-10 max-w-full flex justify-center items-center">
        {isFetching ? (
          ...
          <p className="font-inter font-bold text-bold text-black text-center">
